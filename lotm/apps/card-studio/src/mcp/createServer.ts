...
export function createCardsMcpServer({ repository, downloadBaseUrl, liveViewUrl }: McpOptions): McpServer {
  ...
  server.registerTool(
    'save_card_batch',
    {
      ...
      description:
        ...
        'Dossier concentra una idea central, su contexto, una lectura alternativa y una conclusion; ofrece Auto, Impact, Verdict, Contrast, Evidence, Comment y Longform para cambiar la jerarquia y el ritmo de lectura sin duplicar contenido. Longform esta pensado para evidencia y matices densos, con lectura editorial en dos columnas. ' +
  ...
  server.registerTool(
    'update_card',
    {
      ...
      description: 'Reemplaza el contenido de una carta existente sin cambiar su universo, parte ni posicion. Puede reemplazar la escala tipografica fontSizes.all; Map conserva ademas textStyles por rol.',
