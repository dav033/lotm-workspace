...
export default function CorruptionFileFields({ state, set, accent, onUploadImage, onDownload }) {
  return (
    <div key="corruption-file-fields">
      ...
      <div className="field"><label>Footer (optional)</label><textarea rows={2} maxLength={180} value={state.corruptionFooterText ?? ''} onChange={(e) => set({ corruptionFooterText: e.target.value })} /></div>
