...
export const NEW_CARD_SEEDS: Partial<Record<BuilderCardState['type'], Partial<BuilderCardState>>> = {
  ...
  'Fraud File': {
    fraudName: 'New subject',
    fraudAllegation: 'GREAT SETUP. THEN NOTHING?',
    fraudEvidence: 'Write the receipts behind the fandom take.',
    fraudCounterpoint: 'Write the defense before the comments do.',
    fraudVerdict: 'DISAPPOINTMENT, NOT INCOMPETENCE.',
    fraudSourceLabel: 'Source mood: Reddit',
  },
  'Corruption File': {
